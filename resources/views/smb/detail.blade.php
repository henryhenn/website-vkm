            ...
            <div class="card">
                ...
                <div class="card-footer d-flex">
                    <h6 class="me-3">Ditambahkan oleh: <span
                            class="fw-bold">{{$sekolah_minggu->user_add . ' | ' . tgl_indo(convert_date($sekolah_minggu->created_at))  . ' ' . $sekolah_minggu->created_at->format('H:i')}}</span>
                    </h6>
                    <h6>Diupdate oleh: <span
                            class="fw-bold">{{$sekolah_minggu->user_update . ' | ' .  tgl_indo(convert_date($sekolah_minggu->updated_at)) . ' ' . $sekolah_minggu->updated_at->format('H:i')}}</span>
                    </h6>
                </div>
            </div>
        </div>
