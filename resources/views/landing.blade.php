...
<body class="min-h-screen relative pb-4">
<div class="container">
    <header class="flex">
        <img
        ...
        <div class="w-[830px] h-[146px]">
            <h1 class="text-center text-4xl font-bold space-y-1 mt-6">
                ...
                <span class="text-3xl font-medium block">Jalan 21 No.91, Teluk Gong, Jakarta Utara</span>
                <span class="text-2xl font-medium tracking-wider block">0216615453</span>
            </h1>
        </div>
    </header>
    ...
    <div class="flex flex-col md:flex-row space-x-4 mt-6">
        @foreach($acara as $data)
            <div class="acara-card">
                ...
                <div class="flex flex-col space-y-3 mt-3">
                    ...
                    <div class="space-x-3">
                        <svg class="inline-block align-middle ms-1" xmlns="http://www.w3.org/2000/svg" width="26" height="34" viewBox="0 0 26 34" fill="none">
        ...
        @endforeach
        <div
            class="w-[340px] h-[280px] align-middle flex flex-col justify-center backdrop-blur-[12px] border rounded-3xl border-[#F86F03] bg-gradient-to-b from-[#F8F8F8]/25 to-[#F8F8F8]/75 text-center font-bold"
        >
            ...
            <ul class="space-y-1 mt-6 text-lg">
                @foreach($kebaktian as $kebaktian)
                    <li>{{$kebaktian->kondisi}}: {{$kebaktian->desc}}</li>
                @endforeach
            </ul>
        </div>
    </div>
...
<img src="{{asset('img/Xiao Mi Le.png')}}" class="absolute right-0 bottom-0 -translate-y-5" alt="Xiao Mi Le"
     width="400px">
